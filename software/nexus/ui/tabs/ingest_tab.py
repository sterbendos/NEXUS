...
class DataIngestTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        tcp_group = QGroupBox("TCP Device Session")
        tcp_layout = QFormLayout(tcp_group)
        self.tcp_host_input = QLineEdit()
        self.tcp_host_input.setPlaceholderText("Device IP address")
        self.tcp_port_input = QLineEdit("9000")
        self.tcp_start_btn = QPushButton("Connect TCP")
        self.tcp_stop_btn = QPushButton("Disconnect TCP")
