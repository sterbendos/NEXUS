...
class AIAnalysisTab(QWidget):
    ...
    def set_status(self, text: str, state: str = "warn", running: bool | None = None) -> None:
        if running is True:
    ...
    def set_result(self, result: dict) -> None:
        ...
        if jobs:
            self.hardware_jobs_output.setPlainText(json.dumps(jobs, ensure_ascii=False, indent=2))
